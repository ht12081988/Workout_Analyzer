  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.status === "success") {
        localStorage.setItem("visionfit.auth.admin", JSON.stringify(data.admin));
        router.push("/admin");
      } else {
  ...
  return (
    <main className="flex h-screen w-screen overflow-hidden flex-col md:flex-row">
      <section className="relative hidden items-center justify-center overflow-hidden bg-black p-16 md:flex md:w-[60%]">
        <img
          alt="admin monitoring analytics in a dark studio"
          ...
          <div className="relative overflow-hidden rounded-3xl border border-flame/30 bg-[#0a0a0a]/80 p-12 backdrop-blur-2xl shadow-[0_8px_40px_-12px_rgba(255,107,26,0.2)]">
            ...
            <div className="relative z-10">
              ...
              <h1 className="h1 !text-white mb-8">
                System<br />
                <em className="h-serif-italic text-flame font-normal">Administration.</em>
              </h1>
              <p className="lede mb-12 max-w-lg !text-white/70">
                Manage users, oversee system metrics, and control global biomechanical rules across the platform.
              </p>
              <p className="kicker !text-white/50">
                Root access for VisionFit operation and AI configuration.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          <div className="mb-12">
            ...
            <h2 className="mt-4 h2 text-fg">
              Welcome back.<br />
              <em className="h-serif-italic text-flame font-normal">Admin.</em>
            </h2>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="admin@visionfitai.com"
                  required
                  type="email"
                  value={email}
                />
